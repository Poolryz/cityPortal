...
function HeroTextComponent() {
    return (
        <div className={styles['text-hero']}>
            <span className={styles['text-hero__span']}>Добро пожаловать</span>
            <h1 className={styles['text-hero__title-h1']}>Лысьва</h1>
            <h2 className={styles['text-hero__title']}>Городской портал <Link href={"/"} className={styles['text-hero__link']}>LysvaLife</Link></h2>
            <p className={styles['text-hero__text']}>Лысьва - город богатой историей, сильными традициями и людьми, которые создают будущее.</p>
